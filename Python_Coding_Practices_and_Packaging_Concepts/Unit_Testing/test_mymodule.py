...
'''
MeinTest erbt von unittest.TestCase, was bedeutet:
Sie kann Testmethoden enthalten (müssen mit test_ beginnen).
Sie kann Methoden wie assertEqual, assertTrue, assertFalse, etc. nutzen – diese sind in der Elternklasse TestCase definiert.
'''
